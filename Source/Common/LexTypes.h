...
typedef enum { ENextLevel, ELetterNew, ELetterUsed, ELettersUsed, EQuit, ENew, EPause, EMute, ETileDropped, ESwap, EStill, EScore, EScoreUpdate, EBonusWord, EBonusUsed, EBestWord, EBoardExhausted, EBoardImpossible, EWinComplete } EventType;
